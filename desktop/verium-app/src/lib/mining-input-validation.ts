...
export function parseOptionalBoundedNumber(raw: string, max: number): number | undefined {
...
export function clampMiningVrmPriceUsd(value: number | undefined): number | undefined {
...
export function clampMiningPowerWatts(value: number | undefined): number | undefined {
  if (value == null || !Number.isFinite(value) || value <= 0) {
    return undefined;
  }
...
export function clampMiningCostPerKwh(value: number | undefined): number | undefined {
  if (value == null || !Number.isFinite(value) || value <= 0) {
    return undefined;
  }
