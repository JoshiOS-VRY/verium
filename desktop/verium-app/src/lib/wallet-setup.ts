...
import { isWalletEncrypted, isWalletLocked } from '@/lib/wallet-unlock';

export type WalletSetupMode = 'loading' | 'offline' | 'needs_encrypt' | 'needs_unlock' | 'ready';
...
export function walletSetupModeLabel(coin: CoinId, mode: WalletSetupMode): string {
