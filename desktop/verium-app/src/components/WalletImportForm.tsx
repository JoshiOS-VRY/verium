        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-fg-muted">
              Choose a <span className="text-xs">wallet.dat</span> backup from
              Verium-Qt, this app, or another machine. Your current wallet file
        ...
        {!pendingPath ? (
          ...
          <div className="space-y-2 rounded-md border border-warning/40 bg-warning/10 px-3 py-3 text-xs">
            ...
            <p className="text-fg-muted">
              The node restarts and swaps in this backup. Unlock afterward with
              the passphrase from when that backup was made.
            </p>
