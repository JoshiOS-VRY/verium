import { revenuePeriodLabel, type RevenuePeriod, REVENUE_PERIODS } from '@/lib/mining-revenue';
...
export function RevenuePeriodToggle({ value, onChange, className }: RevenuePeriodToggleProps) {
  return (
    <div
      role="radiogroup"
      aria-label="Revenue period"
      className={cn('inline-flex rounded-md border border-border bg-bg-subtle p-1', className)}
    >
