...
export function MiningProfitCard({ dailyEstimate, period }: MiningProfitCardProps) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Optional — enter power draw and rate to see net USD per {periodSuffix} after electricity.
        </CardDescription>
      </CardHeader>
      <CardContent className="flex flex-col gap-4">
        ...
        {(periodCost != null || netUsd != null) && (
          <div className="grid grid-cols-2 gap-4 border-t border-border pt-3 text-sm md:grid-cols-3">
            {periodCost != null && (
              <div>
                <div className="text-xs uppercase text-fg-subtle">Cost / {periodSuffix}</div>
