...
export function BlockFoundBanner({ height, reward, onDismiss }: BlockFoundBannerProps) {
  return (
    <div
      ...
      <div className="relative flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1 pt-0.5">
          ...
          <p className="mt-0.5 text-sm text-fg-muted">
            You mined{' '}
            <span className="font-semibold tabular-nums text-success">#{formatNumber(height)}</span>
            {reward !== '—' && (
              <>
                {' '}
