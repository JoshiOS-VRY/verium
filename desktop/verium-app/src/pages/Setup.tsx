      ...
      >
        ...
        <CardContent className="flex min-w-0 max-w-full flex-col gap-5">
              ...
              {setupCoinKeystoreUnreadable ? (
                ...
                <>
                  <div className="rounded-md border border-border bg-bg-subtle p-3 text-xs text-fg-muted">
                    <p>
                      Light wallet — your keys are encrypted on this device. Balance and history
                      come from Vericonomy Electrum servers.
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  ...
                  >
                    ...
                    <span className="text-xs text-fg-muted">
                      First time on this machine — choose a passphrase and encrypt a fresh
                      wallet.dat.
                    </span>
                  </button>
                  <button
          ...
          {step === 'recovery' && (
            <div className="flex flex-col gap-4">
              ...
              <p className="text-sm text-fg-muted">
                This phrase is separate from your wallet passphrase: it is the HD master key for
                your addresses. Save it on paper so you can restore on a new device if you lose your
          ...
          {step === 'advanced' && !mobileOnly && (
            <div className="flex flex-col gap-4 text-sm">
              <p className="text-fg-muted">
                Point the app at an existing data directory or remote node. Most users should use
                the simple flow.
              </p>
