...
- _Tests_ for changes to the verium unit tests or QA tests
...
Patches that change Verium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Verium consensus, it must have been
