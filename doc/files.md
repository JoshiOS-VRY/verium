...
- verium.conf: contains configuration settings for veriumd or verium-qt
- veriumd.pid: stores the process id of veriumd while running
...
- debug.log: contains debug information and general logging generated by veriumd or Verium-qt
